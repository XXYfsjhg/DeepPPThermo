...
class RNN(nn.Module):
    ...
    def forward(self, x1, x2, x3, x4, x5, x6):
        ...
        x_sa = torch.cat((x1, x2, x3, x4, x5, x6), dim=1)
...
for rand_seed in list_random:
    ...
    data_CKSAAP_train_1, data_CKSAAP_test_1, data_CKSAAP_valid_1, train_num1, test_num1 = datasplit(
        data_positive_CKSAAP)
    data_CKSAAP_train_0, data_CKSAAP_test_0, data_CKSAAP_valid_0, train_num0, test_num0 = datasplit(
        data_negative_CKSAAP)
    ...
    for epoch in range(50):  # 10iter   1min
        ...
        train_PAAC_0 = dataset.DataLoader(data_PAAC_train_0, batch_size=20, shuffle=True)
        train_PAAC_1 = dataset.DataLoader(data_PAAC_train_1, batch_size=20, shuffle=True)
        ...
        for iteration in range(Iters):
            ...
            pred = rnn(x_DPC, x_CKSAAP, x_CTriad, x_ASDC, x_AAC, x_PAAC)
            loss = criteon(pred, y)
